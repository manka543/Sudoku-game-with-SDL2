...
Loading::Loading(std::shared_ptr<SDL_Renderer>& pRenderer, std::shared_ptr<TTF_Font>& pFont, std::shared_ptr<Board>& pBoard): Paintable(pRenderer, pFont), pLoadingText(nullptr, &SDL_DestroyTexture), pLoadingIndicator(nullptr, &SDL_DestroyTexture), pBoard(pBoard)
{
}
